...
public class EntityRenderer {
	...
	public EntityRenderer(final StaticShader shader, final Matrix4f projectionMatrix) {
		this.shader = shader;
		shader.start();
	...
	private void prepareInstance(final Entity entity) {
		final Matrix4f transformationMatrix = Maths.createTransformationMatrix(entity.getPosition(), entity.getRotX(), entity.getRotY(), entity.getRotZ(), entity.getScale());
