...
public class Character {
	 ...
	 * @param xOffset       - the x distance from the curser to the left edge of
	 *                      the character's quad.
	 * @param yOffset       - the y distance from the curser to the top edge of
	 *                      the character's quad.
	 * @param sizeX         - the width of the character's quad in screen space.
	 * @param sizeY         - the height of the character's quad in screen
	 *                      space.
	 * @param xAdvance      - how far in pixels the cursor should advance after
	 *                      adding this character.
	 */
	protected Character(final int id, final double xTextureCoord, final double yTextureCoord, final double xTexSize, final double yTexSize,
			final double xOffset, final double yOffset, final double sizeX, final double sizeY, final double xAdvance) {
		this.id = id;
