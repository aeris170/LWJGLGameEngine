...
public class ShadowFrameBuffer {
	 ...
	 */
	protected ShadowFrameBuffer(final int width, final int height) {
		WIDTH = width;
		HEIGHT = height;
	...
	protected void bindFrameBuffer() {
		ShadowFrameBuffer.bindFrameBuffer(fbo, WIDTH, HEIGHT);
	}
	 ...
	 */
	private static void bindFrameBuffer(final int frameBuffer, final int width, final int height) {
	 ...
	 */
	private static int createDepthBufferAttachment(final int width, final int height) {
