...
public class SkyboxRenderer {
	...
	/* DAY STARTS AT 0 DEGREES, ENDS AT 180, THEN TRANSITION UNTIL 250, NIGHT STARTS
	 * AT 250, ENDS AT 290, THEN TRANSITION UNTIL 360 (or 0). */
	...
	private static final float[] VERTICES = { -SkyboxRenderer.SIZE, SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE,
	        -SkyboxRenderer.SIZE, SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE, SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE,
	        SkyboxRenderer.SIZE, SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE, SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE,

	        -SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE, SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE,
	        SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE, SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE, SkyboxRenderer.SIZE,
	        SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE, -SkyboxRenderer.SIZE, SkyboxRenderer.SIZE,
	...
	private boolean[] bindTextures() {
		...
		if ((time >= NIGHT_START) && (time < NIGHT_END)) {
			...
			MainGameLoop.player.light
			        .setPosition(new Vector3f(MainGameLoop.player.getPosition().x, MainGameLoop.player.getPosition().y + 10, MainGameLoop.player.getPosition().z));
			...
			tex2Day = true;
			MainGameLoop.player.light
			        .setPosition(new Vector3f(-MainGameLoop.player.getPosition().x, -MainGameLoop.player.getPosition().y, -MainGameLoop.player.getPosition().z));
